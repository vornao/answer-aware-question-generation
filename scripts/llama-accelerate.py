...
class ScriptArguments:
    model_name: Optional[str] = field(default="llama/huggingface", metadata={"help": "the model name"}) #modified
    log_with: Optional[str] = field(default="tensorboard", metadata={"help": "use 'wandb' to log with wandb"})#modified

    dataset_name: Optional[str] = field(default="./dataset/stackoverflow-paired-30k/sft", metadata={"help": "the dataset name"})#modified
    ...
    log_dir:Optional[str] = field(default='logs/sft-llama-30k', metadata={"help": "the logging directory"})
    ...
    output_dir: Optional[str] = field(default="./results/sft-eval-11k", metadata={"help": "the output directory"})
...
base_model = AutoModelForCausalLM.from_pretrained(script_args.model_name, torch_dtype=torch.float16)
