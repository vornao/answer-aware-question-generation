...
class ScriptArguments:
    dataset_name: str = field(
        default="../dataset/stackoverflow-paired/rm",
    ...
    DEBUG: bool = field(
        default=False, metadata={"help": "whether to visualize what's going on"}
    )
    output_dir: str = field(
        default="./dataset/stackoverflow-paired/rm-tokenized",
