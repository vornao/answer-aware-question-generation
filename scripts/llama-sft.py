...
class ScriptArguments:
    model_name: Optional[str] = field(default="./llama/hf", metadata={"help": "the model name"}) #modified
    log_with: Optional[str] = field(default="tensorboard", metadata={"help": "use 'wandb' to log with wandb"})#modified

    dataset_name: Optional[str] = field(default="./dataset/stackoverflow-paired-11k/sft", metadata={"help": "the dataset name"})#modified
    ...
    output_dir: Optional[str] = field(default="./results/sft-eval", metadata={"help": "the output directory"})
