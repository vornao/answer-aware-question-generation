...
def generate_questions(context, model_name='t5-small', max_length=32, num_beams=4, num_return_sequences=4):
    """Generate questions given a context using T5.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Generate questions given a context using T5.')
    parser.add_argument('--context', type=str, help='The context to generate questions for.')
    parser.add_argument('--model_name', type=str, default='t5-small', help='The name of the model to use.')
    parser.add_argument('--max_length', type=int, default=32, help='The maximum length of the generated question.')
    parser.add_argument('--num_beams', type=int, default=4, help='The number of beams to use for beam search.')
    parser.add_argument('--num_return_sequences', type=int, default=4, help='The number of sequences to return.')
